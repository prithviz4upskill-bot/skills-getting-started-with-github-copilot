...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for intramural and regional games",
    ...
    "Theater Club": {
        ...
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "isabella@mergington.edu", "mason@mergington.edu"]
    },
    "Debate Team": {
